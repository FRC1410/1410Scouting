    ...
    return (
        ...
        <>
            ...
            <div className="flex flex-row justify-evenly pb-5">
                <button className="basis-1/4 rounded-full bg-emerald-600 text-white text-7xl font-bold hover:bg-emerald-200 active:bg-teal-600" onClick={() => {setData("auto", "var2", getData("auto", "var2") - 1); forceUpdate()}}>-</button>
            ...
            <div className="flex flex-row justify-evenly pb-5">
                <button className="basis-1/4 rounded-full bg-emerald-600 text-white text-7xl font-bold hover:bg-emerald-200 active:bg-teal-600" onClick={() => {setData("auto", "var3", getData("auto", "var3") - 1); forceUpdate()}}>-</button>
            ...
            <div className="flex flex-row justify-evenly pb-5">
                <button className="basis-1/4 rounded-full bg-emerald-600 text-white text-7xl font-bold hover:bg-emerald-200 active:bg-teal-600" onClick={() => {setData("auto", "var4", getData("auto", "var4") - 1); forceUpdate()}}>-</button>
