    ...
    return (
        <div className='Page'>
            <ButtonGroup variant='contained' color='primary' aria-label='split button' disableRipple fullWidth disableElevation>
                <Button onClick={() => data.teleop.var1++}>Level 1 Cells Scored</Button>
                <Button style={{width: 100}} onClick={() => data.teleop.var1--}>-</Button>
            </ButtonGroup>
            <ButtonGroup variant='contained' color='primary' aria-label='split button' disableRipple fullWidth disableElevation>
                <Button onClick={() => data.teleop.var2++}>Level 2 Cells Scored</Button>
                <Button style={{width: 100}} onClick={() => data.teleop.var2--}>-</Button>
            </ButtonGroup>
            <ButtonGroup variant='contained' color='secondary' aria-label='split button'  disableRipple fullWidth disableElevation>
                <Button className='Missed' onClick={() => data.teleop.var3++}>Shots Missed</Button>
                <Button className='Missed' style={{width: 100}} onClick={() => data.teleop.var3--}>-</Button>
            </ButtonGroup>
