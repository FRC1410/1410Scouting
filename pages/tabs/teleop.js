    ...
    return (
        <>
            ...
            <div className="flex flex-row justify-evenly py-4">
                <button className={"basis-1/3 py-2 rounded text-white text-2xl font-bold background-color:bg-emerald-600 " + (getData("teleop", "var4") ? "bg-gray-400 active:bg-emerald-600" : "bg-emerald-600 active:bg-gray-400")} onClick={() => {setData("teleop", "var4", !getData("teleop", "var4")); forceUpdate()}}>Played Defense</button>
                <button className={"basis-1/3 py-2 rounded text-white text-2xl font-bold background-color:bg-emerald-600 " + (getData("teleop", "var5") ? "bg-gray-400 active:bg-emerald-600" : "bg-emerald-600 active:bg-gray-400")} onClick={() => {setData("teleop", "var5", !getData("teleop", "var5")); forceUpdate()}}>Was Defended</button>
            </div>
            <div className="flex flex-row justify-evenly py-4">
                <button className={"basis-1/3 py-2 rounded text-white text-2xl font-bold backround-color:bg-emerald-600 " + (getData("teleop", "var6") ? "bg-gray-400 active:bg-emerald-600" : "bg-emerald-600 active:bg-gray-400")} onClick={() => {setData("teleop", "var6", !getData("teleop", "var6")); forceUpdate()}}>+15 sec Dead on Field</button>
                <button className={"basis-1/3 py-2 rounded text-white text-2xl font-bold backround-color:bg-emerald-600 " + (getData("teleop", "var7") ? "bg-gray-400 active:bg-emerald-600" : "bg-emerald-600 active:bg-gray-400")} onClick={() => {setData("teleop", "var7", !getData("teleop", "var7")); forceUpdate()}}>2+ Fouls</button>
            </div>
        </>
    )
}
