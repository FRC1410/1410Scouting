...
export default function Reset() {
    return (
        <div className="flex justify-center py-4">
            <button className="w-5/6 py-2 rounded text-white text-2xl font-bold bg-emerald-600 background-color:bg-emerald-600 active:bg-gray-400" onClick={() => { resetData(); returnPregame(); }}>Reset</button>
        </div>
    )
}