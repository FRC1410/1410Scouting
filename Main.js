...
let url = 'https://1d38-2601-282-380-6a20-65d0-5197-86c7-6d88.ngrok.io';
let type = "POST"
let qr;
...
function resetVar() {
    ...
    RCMain.innerText = 'Rotation Control: Failure';
    PCMain.innerText = 'Position Control: Failure';
...
AL2SMinus = document.getElementById("Auto L2 Scored Minus"); AL1SMinus.onmousedown = function () {AL2S--; AL2SMain.innerText = 'Level 2 Cells Scored: ' + AL2S.toString();}
...
TL2SMinus = document.getElementById("Teleop L2 Scored Minus"); TL1SMinus.onmousedown = function () {TL2S--; TL2SMain.innerText = 'Level 2 Cells Scored: ' + TL2S.toString();}
...
RCMain.onmousedown = function () {RC = !RC; if (RC) {RCMain.innerText = 'Rotation Control: Success';} else {RCMain.innerText = 'Rotation Control: Failure';}}
PCMain = document.getElementById("Position");
PCMain.onmousedown = function () {PC = !PC; if (PC) {PCMain.innerText = 'Position Control: Success';} else {PCMain.innerText = 'Position Control: Failure';}}
